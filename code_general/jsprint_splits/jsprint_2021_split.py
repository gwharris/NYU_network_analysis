...
apps = csv_to_list("../../application_programs/jsprints/2021/2021_all3_apps.csv")
ff = open("../../application_programs/jsprints/2021/female_founders_fellow_apps.csv", "w")
gg = open("../../application_programs/jsprints/2021/first_gen_fellow_apps.csv", "w")
ss = open("../../application_programs/jsprints/2021/jsprint_2021_apps.csv", "w")
